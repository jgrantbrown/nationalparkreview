...
# SOURCE HTTP
# # http://www.telegraph.co.uk/travel/destinations/north-america/united-statess/articles/Americas-20-best-national-parks/
...
Review.create( title: "thing", comment: "It was oK", natpark_id: 5, traveller_id: 3)
 ...
 # Natpark.create ([
 # {name: 'Yosemite', states: 'California', description: 'In the heart of Yosemite Valley you’ll spy more natural wonders in a minute than you will anywhere else in an entire day. California’s Yosemite sparkles as a crown jewel of the national parks, showcasing not just glacier-carved beauty but a panoply of superlatives: North America’s highest waterfall (Yosemite Falls); the world’s tallest uninterrupted granite monolith (El Capitan) and mountains that Ralph Waldo Emerson dubbed “unmatched on the globe.” Tioga Pass Road takes you into Yosemite’s high country, including Tuolumne Meadows and its fabulous hiking trails (try the short climb to the top of Pothole Dome). Glacier Point Road leads to perhaps the most spectacular vista in any national park, looking down on Yosemite Valley from 3,200 ft. Wawona, near the southern entrance, provides a starter for the famous Mariposa Grove of sky-scraping sequoias.', fullName: 'Yosemite National Park'},
 #
 # {name: 'Acadia', states: 'Maine', description: 'Every morning, in the predawn darkness, a crowd gathers on Cadillac Mountain, part of Mount Desert Island along the Atlantic seaboard, peering expectantly to the east. As soon as the sun peeks over the horizon they cheer — the first in the country to see the sun’s rays. And thus begins a brand-new day at Maine’s Acadia National Park.
 ...
 #
 # {name: 'Denali', states: 'Alaska', description: 'Only one road accesses six-million-acre Denali, a single, mostly unpaved, 92-mile strip that opens up dramatic views of the subarctic wilderness — and perhaps offers the best chance to experience wildlife of any national park. No cars are allowed beyond Mile 15; everyone must jump aboard a shuttle bus. This is a good thing, given the road’s precipitous, winding nature (and the temptation to keep peering at the ever-more-dramatic landscape).
 #
 ...
 #
 # {name: 'Kenai Fjords', states: 'Alaska', description: 'From the massive Harding Icefield, huge glaciers grind their way slowly but surely to the sea, leaving behind jagged headlands, rocky peninsulas and rough-hewn fjords. Hence is born the wild setting of Alaska’s smallest national park. The best way to explore this icy wonderland is aboard a boat (or kayak) on Resurrection Bay. From your front-row seat you’ll be dazzled by smoky fjords, remote outlying islands and the chance to view blue tidewater glaciers up-close.
 #
